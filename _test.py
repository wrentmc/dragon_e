...
print(encrypt("testing123", "abc123!"))
print(stealthencrypt("testing123","abc123!"))
print(decrypt(stealthencrypt("testing123","abc123!"),'abc123!'))
imageencrypt(hamlet, "abc123!").save("encrypted.png")
# print(imagedecrypt("encrypted.png", "abc123!"))